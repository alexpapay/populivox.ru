...
{
    public class PopuliVoxRuIdentityContext : IdentityDbContext<User>
    {
        public PopuliVoxRuIdentityContext(DbContextOptions<PopuliVoxRuIdentityContext> options)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<IdentityUserLogin<string>>(entity => entity.Property(m => m.ProviderDisplayName).HasMaxLength(85));
        }
    }
}
